...
const envSchema = z.object({
  ...
  RATE_LIMIT_RESET_PASSWORD_MAX: z.coerce.number().default(6),
  RATE_LIMIT_RESEND_VERIFICATION_MAX: z.coerce.number().default(3),
  ...
  SMTP_FROM: z.string().default('noreply@moh.gov.ye'),
  ...
  BACKUP_SCHEDULE_ENABLED: z.coerce.boolean().default(true),
