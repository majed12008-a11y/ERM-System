...
router.post('/sessions', authenticate, authorize('COMMITTEE_CHAIR', 'ETHICS_ADMIN'), validate(createVotingSessionSchema), async (req: Request, res: Response) => {
  try {
...
router.post('/sessions/:id/vote', authenticate, validate(castVoteSchema), async (req: Request, res: Response) => {
  try {
...
router.post('/sessions/:id/close', authenticate, authorize('COMMITTEE_CHAIR', 'ETHICS_ADMIN'), async (req: Request, res: Response) => {
  try {
