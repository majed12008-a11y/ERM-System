...
INSERT INTO security.institutions (code, name_ar, name_en, institution_type_id, address) VALUES
  ...
  ('MOH_YE', 'وزارة الصحة والبيئة', 'Ministry of Public Health and Population', (SELECT id FROM security.institution_types WHERE code = 'GOVERNMENT'), 'الجمهورية اليمنية - صنعاء - شارع الزبيري'),
