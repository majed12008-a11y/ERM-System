...
\restrict EfLlh8zaoAZxblLLdcE75DJECOVvXBNZDXOIfd9p47FVIMzCWGvDdoVXLpIxYSn
...
--
-- Name: test_rls3; Type: SCHEMA; Schema: -; Owner: -
--

CREATE SCHEMA test_rls3;


--
-- Name: test_rls4; Type: SCHEMA; Schema: -; Owner: -
--

CREATE SCHEMA test_rls4;


--
-- Name: test_rls5; Type: SCHEMA; Schema: -; Owner: -
--

CREATE SCHEMA test_rls5;


--
-- Name: test_rls6; Type: SCHEMA; Schema: -; Owner: -
--

CREATE SCHEMA test_rls6;


--
-- Name: test_rls8; Type: SCHEMA; Schema: -; Owner: -
--

CREATE SCHEMA test_rls8;


--
-- Name: test_rls9; Type: SCHEMA; Schema: -; Owner: -
--

CREATE SCHEMA test_rls9;
...
--
-- Name: t1; Type: TABLE; Schema: test_rls3; Owner: -
--

CREATE TABLE test_rls3.t1 (
    id integer NOT NULL,
    name text
);
...
--
-- Name: t1_id_seq; Type: SEQUENCE; Schema: test_rls3; Owner: -
--

CREATE SEQUENCE test_rls3.t1_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: t1_id_seq; Type: SEQUENCE OWNED BY; Schema: test_rls3; Owner: -
--

ALTER SEQUENCE test_rls3.t1_id_seq OWNED BY test_rls3.t1.id;


--
-- Name: t2; Type: TABLE; Schema: test_rls4; Owner: -
--

CREATE TABLE test_rls4.t2 (
    id integer NOT NULL,
    name text
);
...
--
-- Name: t2_id_seq; Type: SEQUENCE; Schema: test_rls4; Owner: -
--

CREATE SEQUENCE test_rls4.t2_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: t2_id_seq; Type: SEQUENCE OWNED BY; Schema: test_rls4; Owner: -
--

ALTER SEQUENCE test_rls4.t2_id_seq OWNED BY test_rls4.t2.id;


--
-- Name: t3; Type: TABLE; Schema: test_rls5; Owner: -
--

CREATE TABLE test_rls5.t3 (
    id integer NOT NULL,
    name text
);

ALTER TABLE ONLY test_rls5.t3 FORCE ROW LEVEL SECURITY;


--
-- Name: t3_id_seq; Type: SEQUENCE; Schema: test_rls5; Owner: -
--

CREATE SEQUENCE test_rls5.t3_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: t3_id_seq; Type: SEQUENCE OWNED BY; Schema: test_rls5; Owner: -
--

ALTER SEQUENCE test_rls5.t3_id_seq OWNED BY test_rls5.t3.id;


--
-- Name: t4; Type: TABLE; Schema: test_rls6; Owner: -
--

CREATE TABLE test_rls6.t4 (
    id integer NOT NULL,
    name text
);

ALTER TABLE ONLY test_rls6.t4 FORCE ROW LEVEL SECURITY;


--
-- Name: t4_id_seq; Type: SEQUENCE; Schema: test_rls6; Owner: -
--

CREATE SEQUENCE test_rls6.t4_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: t4_id_seq; Type: SEQUENCE OWNED BY; Schema: test_rls6; Owner: -
--

ALTER SEQUENCE test_rls6.t4_id_seq OWNED BY test_rls6.t4.id;


--
-- Name: t6; Type: TABLE; Schema: test_rls8; Owner: -
--

CREATE TABLE test_rls8.t6 (
    id integer NOT NULL,
    name text
);

ALTER TABLE ONLY test_rls8.t6 FORCE ROW LEVEL SECURITY;


--
-- Name: t6_id_seq; Type: SEQUENCE; Schema: test_rls8; Owner: -
--

CREATE SEQUENCE test_rls8.t6_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: t6_id_seq; Type: SEQUENCE OWNED BY; Schema: test_rls8; Owner: -
--

ALTER SEQUENCE test_rls8.t6_id_seq OWNED BY test_rls8.t6.id;


--
-- Name: t7; Type: TABLE; Schema: test_rls9; Owner: -
--

CREATE TABLE test_rls9.t7 (
    id integer NOT NULL,
    name text
);

ALTER TABLE ONLY test_rls9.t7 FORCE ROW LEVEL SECURITY;


--
-- Name: t7_id_seq; Type: SEQUENCE; Schema: test_rls9; Owner: -
--

CREATE SEQUENCE test_rls9.t7_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: t7_id_seq; Type: SEQUENCE OWNED BY; Schema: test_rls9; Owner: -
--

ALTER SEQUENCE test_rls9.t7_id_seq OWNED BY test_rls9.t7.id;
...
--
-- Name: t1 id; Type: DEFAULT; Schema: test_rls3; Owner: -
--

ALTER TABLE ONLY test_rls3.t1 ALTER COLUMN id SET DEFAULT nextval('test_rls3.t1_id_seq'::regclass);


--
-- Name: t2 id; Type: DEFAULT; Schema: test_rls4; Owner: -
--

ALTER TABLE ONLY test_rls4.t2 ALTER COLUMN id SET DEFAULT nextval('test_rls4.t2_id_seq'::regclass);


--
-- Name: t3 id; Type: DEFAULT; Schema: test_rls5; Owner: -
--

ALTER TABLE ONLY test_rls5.t3 ALTER COLUMN id SET DEFAULT nextval('test_rls5.t3_id_seq'::regclass);


--
-- Name: t4 id; Type: DEFAULT; Schema: test_rls6; Owner: -
--

ALTER TABLE ONLY test_rls6.t4 ALTER COLUMN id SET DEFAULT nextval('test_rls6.t4_id_seq'::regclass);


--
-- Name: t6 id; Type: DEFAULT; Schema: test_rls8; Owner: -
--

ALTER TABLE ONLY test_rls8.t6 ALTER COLUMN id SET DEFAULT nextval('test_rls8.t6_id_seq'::regclass);


--
-- Name: t7 id; Type: DEFAULT; Schema: test_rls9; Owner: -
--

ALTER TABLE ONLY test_rls9.t7 ALTER COLUMN id SET DEFAULT nextval('test_rls9.t7_id_seq'::regclass);
...
--
-- Name: t1 t1_pkey; Type: CONSTRAINT; Schema: test_rls3; Owner: -
--

ALTER TABLE ONLY test_rls3.t1
    ADD CONSTRAINT t1_pkey PRIMARY KEY (id);


--
-- Name: t2 t2_pkey; Type: CONSTRAINT; Schema: test_rls4; Owner: -
--

ALTER TABLE ONLY test_rls4.t2
    ADD CONSTRAINT t2_pkey PRIMARY KEY (id);


--
-- Name: t3 t3_pkey; Type: CONSTRAINT; Schema: test_rls5; Owner: -
--

ALTER TABLE ONLY test_rls5.t3
    ADD CONSTRAINT t3_pkey PRIMARY KEY (id);


--
-- Name: t4 t4_pkey; Type: CONSTRAINT; Schema: test_rls6; Owner: -
--

ALTER TABLE ONLY test_rls6.t4
    ADD CONSTRAINT t4_pkey PRIMARY KEY (id);


--
-- Name: t6 t6_pkey; Type: CONSTRAINT; Schema: test_rls8; Owner: -
--

ALTER TABLE ONLY test_rls8.t6
    ADD CONSTRAINT t6_pkey PRIMARY KEY (id);


--
-- Name: t7 t7_pkey; Type: CONSTRAINT; Schema: test_rls9; Owner: -
--

ALTER TABLE ONLY test_rls9.t7
    ADD CONSTRAINT t7_pkey PRIMARY KEY (id);
...
--
-- Name: t1 trigger_audit_t1; Type: TRIGGER; Schema: test_rls3; Owner: -
--

CREATE TRIGGER trigger_audit_t1 AFTER INSERT OR DELETE OR UPDATE ON test_rls3.t1 FOR EACH ROW EXECUTE FUNCTION system.fn_log_audit();


--
-- Name: t2 trigger_audit_t2; Type: TRIGGER; Schema: test_rls4; Owner: -
--

CREATE TRIGGER trigger_audit_t2 AFTER INSERT OR DELETE OR UPDATE ON test_rls4.t2 FOR EACH ROW EXECUTE FUNCTION system.fn_log_audit();


--
-- Name: t3 trigger_audit_t3; Type: TRIGGER; Schema: test_rls5; Owner: -
--

CREATE TRIGGER trigger_audit_t3 AFTER INSERT OR DELETE OR UPDATE ON test_rls5.t3 FOR EACH ROW EXECUTE FUNCTION system.fn_log_audit();


--
-- Name: t4 trigger_audit_t4; Type: TRIGGER; Schema: test_rls6; Owner: -
--

CREATE TRIGGER trigger_audit_t4 AFTER INSERT OR DELETE OR UPDATE ON test_rls6.t4 FOR EACH ROW EXECUTE FUNCTION system.fn_log_audit();


--
-- Name: t6 trigger_audit_t6; Type: TRIGGER; Schema: test_rls8; Owner: -
--

CREATE TRIGGER trigger_audit_t6 AFTER INSERT OR DELETE OR UPDATE ON test_rls8.t6 FOR EACH ROW EXECUTE FUNCTION system.fn_log_audit();


--
-- Name: t7 trigger_audit_t7; Type: TRIGGER; Schema: test_rls9; Owner: -
--

CREATE TRIGGER trigger_audit_t7 AFTER INSERT OR DELETE OR UPDATE ON test_rls9.t7 FOR EACH ROW EXECUTE FUNCTION system.fn_log_audit();
...
--
-- Name: t1 p1; Type: POLICY; Schema: test_rls3; Owner: -
--

CREATE POLICY p1 ON test_rls3.t1 FOR INSERT WITH CHECK (true);


--
-- Name: t1; Type: ROW SECURITY; Schema: test_rls3; Owner: -
--

ALTER TABLE test_rls3.t1 ENABLE ROW LEVEL SECURITY;

--
-- Name: t2 p2; Type: POLICY; Schema: test_rls4; Owner: -
--

CREATE POLICY p2 ON test_rls4.t2 FOR INSERT WITH CHECK (true);


--
-- Name: t2; Type: ROW SECURITY; Schema: test_rls4; Owner: -
--

ALTER TABLE test_rls4.t2 ENABLE ROW LEVEL SECURITY;

--
-- Name: t3 p3; Type: POLICY; Schema: test_rls5; Owner: -
--

CREATE POLICY p3 ON test_rls5.t3 FOR INSERT WITH CHECK (true);


--
-- Name: t3; Type: ROW SECURITY; Schema: test_rls5; Owner: -
--

ALTER TABLE test_rls5.t3 ENABLE ROW LEVEL SECURITY;

--
-- Name: t4 p4; Type: POLICY; Schema: test_rls6; Owner: -
--

CREATE POLICY p4 ON test_rls6.t4 USING (true) WITH CHECK (true);


--
-- Name: t4; Type: ROW SECURITY; Schema: test_rls6; Owner: -
--

ALTER TABLE test_rls6.t4 ENABLE ROW LEVEL SECURITY;

--
-- Name: t6 p6; Type: POLICY; Schema: test_rls8; Owner: -
--

CREATE POLICY p6 ON test_rls8.t6 FOR INSERT WITH CHECK (true);


--
-- Name: t6; Type: ROW SECURITY; Schema: test_rls8; Owner: -
--

ALTER TABLE test_rls8.t6 ENABLE ROW LEVEL SECURITY;

--
-- Name: t7 p7; Type: POLICY; Schema: test_rls9; Owner: -
--

CREATE POLICY p7 ON test_rls9.t7 FOR INSERT TO ethics_app WITH CHECK (true);


--
-- Name: t7; Type: ROW SECURITY; Schema: test_rls9; Owner: -
--

ALTER TABLE test_rls9.t7 ENABLE ROW LEVEL SECURITY;
